        ...
        <div className="flex-shrink-0 p-4 border-b border-gray-100">
          {loading ? (
            ...
            <div className="flex items-center gap-3">
              <div className="h-10 w-10 rounded-full bg-gray-100 animate-pulse flex-shrink-0"></div>
            ...
            // Fallback if no user but authenticated
            <div className="flex items-center gap-3">
              <Avatar className="h-10 w-10 flex-shrink-0 ring-2 ring-red-100">
                <AvatarFallback className="bg-red-100 text-red-700 text-sm font-medium">
                  U
              ...
              <div className="min-w-0 flex-1">
                <h3 className="font-semibold text-sm text-gray-900">User</h3>
