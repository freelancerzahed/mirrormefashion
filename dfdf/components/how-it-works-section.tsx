...
export default function HowItWorksSection({ onSectionChange, scrollToSection }: HowItWorksSectionProps) {
  return (
    <section
      ...
      className="min-w-full h-full snap-center relative overflow-hidden bg-gradient-to-br from-primary-50 to-white bg-[url('/img/bg-fashion.jpeg')] bg-cover bg-center"
    >
      {/* Background Effects */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto h-full flex flex-col justify-center px-6 py-8">
        <div className="text-center mb-8">
          ...
          {/* Title (Purple) */}
          <h2 className="text-2xl lg:text-4xl font-black text-purple-700 mb-3 leading-tight tracking-tight">
            How the Mirror Me Fashion
            <span className="block text-purple-500">AI Fashion Advisor Works</span>
          </h2>

          {/* Updated Description */}
          <p className="text-base lg:text-lg text-gray-700 max-w-3xl mx-auto leading-relaxed font-medium">
        ...
        <div className="text-center flex justify-center gap-6">
          <Button
            size="lg"
            className="w-56 px-6 py-3 text-lg font-bold rounded-full shadow-2xl transition-all duration-300 group bg-gradient-to-r from-primary-600 to-primary-500 hover:from-primary-700 hover:to-primary-600 text-white relative overflow-hidden"
                          onClick={() => {
          ...
          <Button
            size="lg"
            className="w-56 px-6 py-3 text-lg font-bold rounded-full shadow-2xl transition-all duration-300 group bg-gradient-to-r from-purple-600 to-purple-500 hover:from-purple-700 hover:to-purple-600 text-white relative overflow-hidden"
           onClick={() => {
