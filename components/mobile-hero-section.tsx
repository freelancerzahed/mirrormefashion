...
import { Play, Sparkles, ChevronDown, Star, Users, Zap } from "lucide-react"
      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center px-4 py-6 safe-area-inset-top">
        <div className="text-center text-white max-w-xs w-full">
          ...
          <div className="mb-8 animate-slide-up">
            ...
            <p className="text-sm text-primary-200 opacity-90 font-medium">Powered by advanced AI technology</p>
          </div>
